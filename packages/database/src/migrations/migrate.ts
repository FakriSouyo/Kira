...
export function runMigrations(db: Database.Database): void {
  ...
  for (const name of MIGRATIONS) {
    ...
    const rebuildsReferencedTable = name === './0007_canonical_lifecycle.sql' || name === './0011_turn_model_calls.sql';
