...
export function renderHelp(): string {
  return [
    ...
    `  ${color.green('/continue')}                 Resume the only unambiguous interrupted Judge Execution in this Session`,
    ...
    `  ${color.green('/setup')}                    Interactive setup wizard`,
    `  ${color.green('/status')}                   Show config status (keys masked)`,
    `  ${color.green('/providers')}                List AI providers`,
